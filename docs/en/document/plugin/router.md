...
Please refer to [Configuration Center User's Manual](../user-guide/configuration-center.md).
...
|:-----|:--|:--|
|SpringCloud Edgware.SR2 - 2021.0.0<br/>Dubbo 2.6.x-2.7.x|servicecomb-service-center<br/>Zookeeper<br/>Nacos|Asynchronous invocation is not supported.|
...
Configuring Routing Rules, please refer to [Configuration Center User's Manual](../user-guide/configuration-center.md).
