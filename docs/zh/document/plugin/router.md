...
请参考[配置中心使用手册](../user-guide/configuration-center.md)。
...
|:-----|:--|:--|
|SpringCloud Edgware.SR2 - 2021.0.0<br/>Dubbo 2.6.x-2.7.x|servicecomb-service-center<br/>Zookeeper<br/>Nacos|不支持异步调用|
...
配置路由规则，请参考[配置中心使用手册](../user-guide/configuration-center.md)。
